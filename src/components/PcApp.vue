<template>
        ...
        <div class="middle">
            <div class="middleContainer wrapper_01">
                <div class="textContainer">
                    ...
                    <span class="subTitle">In the world of Genesis Monopoly, you will use unique NFT characters to earn coins and use your strategies to win in board games to obtain our virtual token F. You can use F coins to purchase houses in a virtual city to generate more gold coin income, and you can also use F coins to obtain the jurisdiction pricing power of the city through voting. Having more gold coins to participate in higher level chess and card games to obtain more virtual tokens, creating a blockchain metaverse world where players can earn profits through the game</span>
                </div>
                <div class="stepContainer">
                    ...
                    <PcStepItem class="step1" title="第一步" desc="Publish NFTs on the Founder platform, and each NFT can receive a daily salary (in gold coins) based on their profession. Gold coins can be used for playing board and card games, as well as games developed on the Founder platform."/>
                    <PcStepItem class="step2" title="第二步" desc="Players win battles and actively obtain virtual tokens through games on the Founder platform"/>
                    <PcStepItem class="step3" title="第三步" desc="By using token F, one can purchase land and build their own house in the virtual world to generate gold income, or vote and represent in the virtual world through token F, thus achieving a player made metaverse world."/>
                </div>
            </div>
        </div>
  ...
  <script>
  import PcStepItem from './PcStepItem.vue';
  ...
  <style scoped>
    ...
    @keyframes zoomInOut {
        ...
        60%, 80%, 100% { transform: scale(0); opacity: 0;}
    }
